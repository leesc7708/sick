...
export const translations: Record<Lang, Record<string, string>> = {
  ko: {
    ...
    dc_ai_note: '지금은 자주 묻는 증상 위주의 안내입니다. 자유롭게 문장으로 물어보는 AI 상담은 준비 중입니다.',
  ...
  en: {
    ...
    dc_ai_note: 'For now this guides common symptoms. Free-text AI consultation is coming soon.',
  ...
  zh: {
    ...
    dc_ai_note: '目前以常见症状指引为主。自由文字的AI咨询正在准备中。',
  ...
  ja: {
    ...
    dc_ai_note: '現在はよくある症状の案内が中心です。自由な文章で聞けるAI相談は準備中です。',
  ...
  vi: {
    ...
    dc_ai_note: 'Hiện tại chủ yếu hướng dẫn các triệu chứng thường gặp. Tư vấn AI bằng văn bản tự do đang được chuẩn bị.',
  ...
  th: {
    ...
    dc_ai_note: 'ตอนนี้เน้นแนะนำอาการที่พบบ่อย ระบบปรึกษา AI แบบพิมพ์ข้อความอิสระกำลังเตรียมการ',
  ...
  es: {
    ...
    dc_ai_note: 'Por ahora guía síntomas comunes. La consulta con IA de texto libre está en preparación.',
