  ...
  return (
    <View style={[styles.wrap, { backgroundColor: colors.bg }]}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        {list.map((m) => (
          <View key={m.id} style={[styles.card, shadow.card, { backgroundColor: colors.card }]}>
        ...
        <View style={[styles.addBox, shadow.card, { backgroundColor: colors.card }]}>
          ...
          <TextInput value={name} onChangeText={setName} placeholder="약 이름 (예: 혈압약)" placeholderTextColor={colors.textMuted} style={[styles.input, { backgroundColor: colors.g50, borderColor: colors.border, color: colors.text }]} />
          <TextInput value={time} onChangeText={setTime} placeholder="복용 시간(선택) (예: 아침 08:00)" placeholderTextColor={colors.textMuted} style={[styles.input, { marginTop: spacing.sm, backgroundColor: colors.g50, borderColor: colors.border, color: colors.text }]} />
        ...
        <View style={[styles.addBox, shadow.card, { backgroundColor: colors.card }]}>
          ...
          <TextInput value={allergies} onChangeText={setAllergies} placeholder="예: 페니실린, 아스피린" placeholderTextColor={colors.textMuted} style={[styles.input, { backgroundColor: colors.g50, borderColor: colors.border, color: colors.text }]} />
